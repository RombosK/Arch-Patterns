...
class CourseFactory:
    ...
    @classmethod
    def delete(cls, type_, name, category):
        return cls.types[type_](name, category)
...
class Engine:
    ...
    @staticmethod
    def delete_user(type_, name):
        return UserFactory.delete(type_, name)
    ...
    @staticmethod
    def delete_course(type_, name, category):
        return CourseFactory.delete(type_, name, category)
