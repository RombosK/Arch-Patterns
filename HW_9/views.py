...
from patterns.gen_patterns import Engine, Logger, MapperRegistry, UserFactory, Student
...
from patterns.behave_patterns import EmailNotifier, SmsNotifier, CreateView, \
    BaseSerializer, ListView, DeleteView, TemplateView
from patterns.arch_sys_patterns import UnitOfWork
...
# Удаление студентов
@AppRoute(routes=routes, url='/delete_student/')
class StudentDeleteView(DeleteView):
    template_name = 'delete_student.html'

    def delete_obj(self, students: dict):
        name = students['name']
        name = site.decode_value(name)
        UserFactory.delete('student', name)
        del_obj = site.delete_user('student', name)
